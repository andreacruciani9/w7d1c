package it.epicode.w7d1c.security;

import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.security.Keys;
import it.epicode.w7d1c.model.Dipendente;
import it.epicode.w7d1c.exception.UnAuthorizedException;
...
public class JwtTools {
    ...
    public String createToken(Dipendente dipendente){
        return Jwts.builder().subject(dipendente.getEmail()).issuedAt(new Date(System.currentTimeMillis())).
